...
- Great for interactive graphics, animations, and data visualization
...
You can add a fourth argument to color settings in p5.js
This is for RGBA, where the A stands for Alpha channel, meaning transparency.
A values run from 0 for totally transparent to 255 for totally opaque. 
